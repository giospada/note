...
Strange days:
The Truman Show: Truman vive una vita normale, fino a quando non si accorge di che alcune 
Elephant Gus: Un giorno due alunni di una scuola decidono di andare e sparare a tutti i compagni come se fosse un avventura incredibilmente bella
The road: in un mondo post apocalittico un padre e un figlio cercano la speranza di un clima migliore, in questo viaggio tra fatiche e stenti cerceranno perennemente cibo e caldo scappando da cannibali e furfanti  
Joker:
Parasite:
